...
import {
  ...
  FlatList, ActivityIndicator, Alert, KeyboardAvoidingView, Platform, Modal,
} from 'react-native'
import { useLocalSearchParams, useRouter } from 'expo-router'
import { BarCodeScanner } from 'expo-barcode-scanner'
import { useDailyMeals, searchOpenFoodFacts, fetchByBarcode } from '../../../src/hooks/useNutrition'
...
const styles = StyleSheet.create({
  ...
  confirmMacros: { color: '#2563eb', marginBottom: 20 },
  amountLabel: { fontSize: 14, color: '#666', marginBottom: 6 },
  amountInput: { borderWidth: 1, borderColor: '#ddd', borderRadius: 10, padding: 14, fontSize: 18, marginBottom: 20, textAlign: 'center' },
